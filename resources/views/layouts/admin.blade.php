...
<!-- BEGIN VENDOR JS-->
<script src='{{asset("assets/admin/vendors/js/tables/datatable/datatables.min.js")}}' type="assets/text/javascript"></script>
<script src='{{asset("assets/admin/vendors/js/tables/datatable/dataTables.buttons.min.js")}}' type="text/javascript"></script>
<script src='{{asset("assets/admin/vendors/js/forms/toggle/bootstrap-switch.min.js")}}' type="assets/text/javascript"></script>
<script src='{{asset("assets/admin/vendors/js/forms/toggle/bootstrap-checkbox.min.js")}}' type="assets/text/javascript"></script>
