        ...
        <ul class="navigation navigation-main" id="main-menu-navigation" data-menu="menu-navigation">
            ...
            <li class="nav-item"><a href=""><i class="la la-home"></i>
                ...
                <ul class="menu-content">
                    ...
                    <li><a class="menu-item" href="{{route('add.language')}}" data-i18n="nav.dash.crypto">أضافة
                        لغة جديد </a>
                    </li>
                </ul>
            </li>
            ...
            <li class="nav-item"><a href=""><i class="la la-group"></i>
                ...
                <span
                {{-- class="badge badge badge-danger badge-pill float-right mr-2">{{App\Models\categories\MainCatigorie::active()->count()}}</span> --}}
                class="badge badge badge-danger badge-pill float-right mr-2">{{App\Models\categories\MainCatigorie::count()}}</span>
            </a>
                <ul class="menu-content">
                    <li class="active"><a class="menu-item" href="{{route('admin.categories')}}"
                                          data-i18n="nav.dash.ecommerce"> عرض الكل </a>
                    </li>
                    <li><a class="menu-item" href="{{route('admin.add.categorie')}}" data-i18n="nav.dash.crypto">أضافة
                        قسم جديد </a>
                    </li>
                </ul>
            </li>
            ...
            <li class="nav-item"><a href=""><i class="la la-male"></i>
                ...
                <span
                    class="badge badge badge-success badge-pill float-right mr-2">{{App\Models\Vendors\Vendor::count()}}</span>
            </a>
                <ul class="menu-content">
