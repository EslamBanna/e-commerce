                    ...
                    <div class="col-md-12">
                        <div class="card">
                            ...
                            <div class="card-content collapse show">
                                <div class="card-body">
                                    <form class="form" action="{{route('insert.language')}}" method="POST"
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-md-6">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="text" value="" id="locale"
                                                               class="form-control"
...
<script>
    function passData(){
      document.getElementById('active').value = document.getElementById('status').checked;
  }
  </script>
@endsection
